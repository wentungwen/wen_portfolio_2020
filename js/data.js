...
new Vue({
  ...
  data: {
    ...
    schoolList: [
      {
        ...
        descript: `廣告系四年，給予我對於使用者與行銷的基本知識，如何找出消費者洞察，剖析persona，進行質化與量化分析，這些經驗將會帶領我更貼近使用者去改善產品。`,
      ...
      },
      {
        ...
        descript: `南科實中是一所自由開放的學校，位於園區旁邊，以數理為主。學生穿便服上課，溜滑板跑班，但同時也十分自律，我在高二時第一次接觸到C++程式設計。`,
    ...
    css: [
      { name: "HTML5", num: "5" },
      { name: "CSS3", num: "5" },
      { name: "SASS / SCSS", num: "5" },
      { name: "RWD web design", num: "4" },
      { name: "BEM", num: "4" },
      { name: "Bootstraps", num: "3" },
    ],
    js: [
      ...
      { name: "Vue.js 2", num: "3" },
      { name: "JQuery", num: "3" },
      { name: "MVC Pattern", num: "2" },
    ],

    art: [
      { name: "PhotoShop", num: "5" },
      { name: "InDesign", num: "5" },
      { name: "Illustrator", num: "3" },
      { name: "Premiere", num: "2" },
    ],
    language: [
      { lan: "Chinese", lev: "母語" },
      { lan: "English", lev: "IELTS 7.0" },
      { lan: "Spanish", lev: "A1" },
    ],
        ...
        case: [
          {
            ...
            details: [
              ...
              "define 做完調研，總共在交流版回收了約220份語交相關問卷，與華語中心學生和國合處訪談，也詢問波士頓大學粉專相關經歷。",
              "Solution 我決定在政大推動「國際角落」：一個媒合外籍學生和本地學生的平台，在每周的特定時間與地點，不需報名與繳費，學生可以到場進行語言交換。",
              "result：這個活動僅運作一個學期，便交由政大宿服會經營，改名為international cafe，並持續經營至今。最大的問題是缺少執行單位與場地，其他衍生問題如活動內容的缺乏，本地生與外籍生供需不均，宣傳管道問題等等。",
            ],
          },
          {
          ...
          },
          {
            ...
            details: [
              ...
              "Define做完市場分析，與十五個工程師和設計師深度訪談，並與相關粉專洽詢後，發現因為找人阻力過大，如社團人數太多、沒有完整產品構想而不敢發文。persona為初階偏中階工程師，已有相當技能，試圖培養新技能以找到更好的工作，可營利為其次。",
